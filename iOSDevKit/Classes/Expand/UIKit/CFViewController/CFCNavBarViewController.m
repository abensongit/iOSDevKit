...
static CGFloat const STATUS_NAVIGATION_BAR_TAG = 888888.0f; // 状态栏+导航条容器TAG值
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    if (!self.fd_prefersNavigationBarHidden) {
        ...
        [self setNavigationBarTitleViewTitleColor];
    }
}
...
{
    UIFont *navBarTitleFont = [self prefersNavigationBarTitleFont];
    UIColor *navBarTitleColor = [self prefersNavigationBarTitleColor];
    
    // 系统默认值
    {
        NSDictionary *titleTextAttributes = @{ NSFontAttributeName : navBarTitleFont,
                                               NSForegroundColorAttributeName : navBarTitleColor};
    ...
    // 自定义标题
    {
        ...
        NSString *subTitle = [self.navigationBarTitleViewTitle substringToIndex:titleLength];
        [label setText:subTitle];
        [label setFont:navBarTitleFont];
        [label setTextColor:navBarTitleColor];
...
#pragma mark 设置导航条自定义标题视图
- (BOOL)prefersNavigationNavigationBarTitleView
{
    return NO;
}
...
#pragma mark 设置导航栏按钮控件标题字体
- (UIFont *)prefersNavigationBarButtonItemTitleFont
{
...
#pragma mark 设置导航栏按钮控件标题颜色（选中）
- (UIColor *)prefersNavigationBarButtonItemTitleColorSelect
{
...
{
    return [self prefersNavigationBarButtonItemTitleFont];
}
...
{
    return [self prefersNavigationBarButtonItemTitleColorNormal];
}
...
{
    return [self prefersNavigationBarButtonItemTitleColorSelect];
}
...
#pragma mark 创建导航 UIBarButtonItem 文字
- (UIBarButtonItem *)createBarButtonItemWithTitle:(NSString *)title action:(SEL)action
{
    return [self createBarButtonItemWithTitle:title target:self action:action];
}

#pragma mark 创建导航 UIBarButtonItem 文字
- (UIBarButtonItem *)createBarButtonItemWithTitle:(NSString *)title target:(id)target action:(SEL)action
{
    UIFont *titleFont = [self prefersNavigationBarButtonItemTitleFont];
    UIColor *titleNormalColor = [self prefersNavigationBarButtonItemTitleColorNormal];
    UIColor *titleSelectColor = [self prefersNavigationBarButtonItemTitleColorSelect];
    
    return [self createBarButtonItemWithTitle:title
                              titleFont:titleFont
                             titleColor:titleNormalColor
                       highlightedColor:titleSelectColor
...
#pragma mark 创建导航 UIBarButtonItem 文字
- (UIBarButtonItem *)createBarButtonItemWithTitle:(nullable NSString *)title
                           ...
                           highlightedColor:(nullable UIColor *)highlightedColor
                            titleEdgeInsets:(UIEdgeInsets)titleEdgeInsets
                                     ...
                                     action:(SEL)action
{
    UIButton *button = [self createButtonWithTitle:title titleFont:titleFont titleColor:titleColor highlightedColor:highlightedColor titleEdgeInsets:titleEdgeInsets target:target action:action];
    return [[UIBarButtonItem alloc] initWithCustomView:button];
}

#pragma mark 创建导航 UIBarButtonItem 图片
- (UIBarButtonItem *)createBarButtonItemWithImage:(NSString *)image action:(SEL)action
{
    return [self createBarButtonItemWithImage:image target:self action:action];
}

#pragma mark 创建导航 UIBarButtonItem 图片
- (UIBarButtonItem *)createBarButtonItemWithImage:(NSString *)image target:(id)target action:(SEL)action
{
    return [self createBarButtonItemWithImage:image highLightedImage:nil imageEdgeInsets:UIEdgeInsetsZero target:target action:action];
}

#pragma mark 创建导航 UIBarButtonItem 图片
- (UIBarButtonItem *)createBarButtonItemWithImage:(NSString *)image
                                 highLightedImage:(NSString *)highLightedImage
                                  imageEdgeInsets:(UIEdgeInsets)imageEdgeInsets
                                           target:(id)target
                                           action:(SEL)action
{
    UIButton *button = [self createButtonWithImage:image highLightedImage:highLightedImage imageEdgeInsets:imageEdgeInsets target:target action:action];
    return [[UIBarButtonItem alloc] initWithCustomView:button];
}

#pragma mark 创建导航 UIButton 文字
- (UIButton *)createButtonWithTitle:(NSString *)title action:(SEL)action
{
    return [self createButtonWithTitle:title target:self action:action];
}
...
#pragma mark 创建导航 UIButton 文字
- (UIButton *)createButtonWithTitle:(nullable NSString *)title
                          titleFont:(nullable UIFont *)titleFont
                         titleColor:(nullable UIColor *)titleColor
                   highlightedColor:(nullable UIColor *)highlightedColor
                    titleEdgeInsets:(UIEdgeInsets)titleEdgeInsets
                             ...
                             action:(SEL)action
{
    UIButton *button = (UIButton *) [self createNavigationBarButtonItemTypeCustomTitle:title
                                                                             titleFont:titleFont
                                                                      titleNormalColor:titleColor
                                                                      titleSelectColor:highlightedColor
                                                                        iconNameNormal:nil
                                                                        iconNameSelect:nil
                                                                                action:action
                                                                                target:target];
...
#pragma mark 创建导航 UIButton 图片
- (UIButton *)createButtonWithImage:(NSString *)image action:(SEL)action
{
    return [self createButtonWithImage:image target:self action:action];
}

#pragma mark 创建导航 UIButton 图片
- (UIButton *)createButtonWithImage:(NSString *)image target:(id)target action:(SEL)action
{
    return [self createButtonWithImage:image highLightedImage:nil imageEdgeInsets:UIEdgeInsetsZero target:target action:action];
}
...
- (UIButton *)createButtonWithImage:(NSString *)image
                   highLightedImage:(NSString *)highLightedImage
                    imageEdgeInsets:(UIEdgeInsets)imageEdgeInsets
                             ...
                             action:(SEL)action
{
    UIButton *button = (UIButton *) [self createNavigationBarButtonItemTypeCustomTitle:nil
                                                                             titleFont:nil
                                                                      titleNormalColor:nil
                                                                      titleSelectColor:nil
                                                                        iconNameNormal:image
                                                                        iconNameSelect:highLightedImage
                                                                                action:action
                                                                                target:target];
...
- (void)setupNavigationBarViewDefault
{
    ...
    // 标题区域
    {
        ...
        if ([self prefersNavigationNavigationBarTitleView]) {
...
{
    // 系统默认标题
    [self.navigationItem setTitle:navigationBarTitleViewTitle];
...
#pragma mark 设置导航栏中间标题文字颜色
- (void)setNavigationBarTitleViewTitleColor
{
    UIColor *navBarTitleColor = [self prefersNavigationBarTitleColor];
    
    // 系统默认标题
    {
        NSDictionary *titleTextAttributes = @{ NSForegroundColorAttributeName : navBarTitleColor};
        [self.navigationController.navigationBar setTitleTextAttributes:titleTextAttributes];
    }
    
    // 自定义视图
    if (_navigationBarTitleLabel) {
        [_navigationBarTitleLabel setTextColor:navBarTitleColor];
    }
}
