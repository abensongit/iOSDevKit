...
#define ICON_TAB_BAR_ITEM_FINDER_NORMAL                             @"icon_tabbar_item_finder"
#define ICON_TAB_BAR_ITEM_FINDER_SELECT                             @"icon_tabbar_item_finder_select"
#define ICON_TAB_BAR_ITEM_SETTING_NORMAL                            @"icon_tabbar_item_mine"
#define ICON_TAB_BAR_ITEM_SETTING_SELECT                            @"icon_tabbar_item_mine_select"
