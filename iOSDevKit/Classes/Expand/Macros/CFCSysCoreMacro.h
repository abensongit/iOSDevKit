...
#define NSUSERDEFAULTS_OBJ_SET(VALUE,KEY)    [[NSUserDefaults standardUserDefaults] setObject:(VALUE) forKey:(KEY)];[[NSUserDefaults standardUserDefaults] synchronize]
