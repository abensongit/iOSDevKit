...
#pragma mark - 标签栏标题
#define STR_TAB_BAR_ITEM_NAME_HOME                                                   @"首页"
#define STR_TAB_BAR_ITEM_NAME_FINDER                                                 @"发现"
#define STR_TAB_BAR_ITEM_NAME_SETTING                                                @"设置"

#pragma mark - 导航栏标题
#define STR_NAVIGATION_BAR_TITLE_HOME                                                @"首页"
#define STR_NAVIGATION_BAR_TITLE_FINDER                                              @"发现"
#define STR_NAVIGATION_BAR_TITLE_SETTING                                             @"设置"
